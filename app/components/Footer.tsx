...
export function Footer() {
    return (
        <>
            {/* Extended background for footer overscroll */}
            <div className="fixed inset-x-0 bottom-0 translate-y-full h-screen bg-black/50 backdrop-blur-md pointer-events-none -z-10" />

            <footer className="border-t border-white/10 bg-black/50 backdrop-blur-md mt-auto sticky top-[100vh]" style={{ boxShadow: '0 100vh 0 100vh rgba(0, 0, 0, 0.5)' }}>

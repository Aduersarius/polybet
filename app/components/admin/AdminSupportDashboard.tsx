...
export function AdminSupportDashboard() {
  const { data: session } = useSession() as { data: any; isPending: boolean };
    ...
    <>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-[#9ca3af]">Manage support tickets and customer requests</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="p-5 rounded-xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-sm font-medium text-[#9ca3af]">Open Tickets</h3>
            </div>
          ...
          {/* Today's Tickets */}
          <div className="p-5 rounded-xl bg-[#111113] border border-white/5">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-lg bg-blue-500/20">
                <TrendingUp className="w-5 h-5 text-blue-400" />
              </div>
              <h3 className="text-sm font-medium text-[#9ca3af]">Today</h3>
            </div>
            <p className="text-3xl font-bold text-blue-400">{stats.ticketsToday}</p>
            <p className="text-xs text-[#6b7280] mt-1">{stats.resolvedToday} resolved</p>
          </div>
          ...
          <div className="p-5 rounded-xl bg-[#111113] border border-white/5">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-sm font-medium text-[#9ca3af]">Avg Response</h3>
            </div>
            <p className="text-3xl font-bold text-purple-400">{stats.avgFirstResponseTime}m</p>
            <p className="text-xs text-[#6b7280] mt-1">First response time</p>
          </div>
          ...
          <div className="p-5 rounded-xl bg-[#111113] border border-white/5">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-sm font-medium text-[#9ca3af]">Avg Resolution</h3>
            </div>
            <p className="text-3xl font-bold text-orange-400">{stats.avgResolutionTime}h</p>
            <p className="text-xs text-[#6b7280] mt-1">Time to resolve</p>
          </div>
        </div>
      )}

      {/* Filters */}
      <div className="mb-6 p-6 rounded-xl bg-[#111113] border border-white/5">
      ...
      <div className="p-6 rounded-xl bg-[#111113] border border-white/5">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-xl font-bold text-white">Ticket Inbox</h2>
        </div>
        <TicketInbox
          filters={filters}

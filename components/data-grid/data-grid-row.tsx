...
function DataGridRowImpl<TData>({
  ...
  return (
    <div
      ...
      ref={rowRef}
      className={cn(
        "absolute flex w-full border-b border-white/5",
        ...
        return (
          <div
            ...
            className={cn({
              ...
              "border-e border-white/5": showEndBorder && columnId !== "select",
              "border-s border-white/5": showStartBorder && columnId !== "select",
            })}
            style={{

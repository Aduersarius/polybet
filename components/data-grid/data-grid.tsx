  ...
  return (
    ...
    >
      ...
      <div
        ...
        tabIndex={0}
        ref={dataGridRef}
        className="relative grid select-none overflow-auto rounded-xl border border-white/10 bg-black/20 backdrop-blur-xl focus:outline-none"
        style={{
          ...columnSizeVars,
          maxHeight: `${height}px`,
        }}
      ...
      >
        <div
          ...
          ref={headerRef}
          className="sticky top-0 z-10 grid border-b border-white/10 bg-zinc-900/50 backdrop-blur-md"
        >
          {table.getHeaderGroups().map((headerGroup, rowIndex) => (
            <div
              ...
              tabIndex={-1}
              className="flex w-full overflow-hidden font-semibold text-zinc-300"
            >

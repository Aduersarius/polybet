...
export const buttonStyles = tv({
  base: [
    ...
    "*:data-[slot=color-swatch]:-mx-0.5 *:data-[slot=color-swatch]:shrink-0 *:data-[slot=color-swatch]:self-center *:data-[slot=color-swatch]:size-5",
  ],
  variants: {
    intent: {
      primary:
    ...
    size: {
      xs: [
        "min-h-8 gap-x-1.5 px-[calc(0.75rem-1px)] py-[calc(0.375rem-1px)] text-sm sm:min-h-7 sm:px-2 sm:py-[calc(0.375rem-1px)] sm:text-xs/4",
      ...
      sm: [
        "min-h-9 gap-x-1.5 px-3 py-[calc(0.5rem-1px)] sm:min-h-8 sm:px-[calc(0.75rem-1px)] sm:py-[calc(0.375rem-1px)] sm:text-sm/5",
        "*:data-[slot=icon]:size-4.5 sm:*:data-[slot=icon]:size-4",
        "*:data-[slot=loader]:size-4.5 sm:*:data-[slot=loader]:size-4",
      ],
      md: [
        "min-h-10 gap-x-2 px-[calc(0.875rem-1px)] py-[calc(0.625rem-1px)] sm:min-h-9 sm:px-3 sm:py-[calc(0.375rem-1px)] sm:text-sm/6",
        "*:data-[slot=icon]:size-5 sm:*:data-[slot=icon]:size-4",
        "*:data-[slot=loader]:size-5 sm:*:data-[slot=loader]:size-4",
      ],
      lg: [
        "min-h-10 gap-x-2 px-[calc(0.875rem-1px)] py-[calc(0.75rem-1px)] sm:min-h-9 sm:px-3 sm:py-[calc(0.375rem-1px)] sm:text-sm/7",

  ...
  return (
    <Group
      ...
      className={cx(
        ...
        // text
        "has-[[data-slot=text]:last-child]:[&_input]:pr-[calc(var(--input-gutter-end)+0.5rem)] has-[[data-slot=text]:first-child]:[&_input]:pl-[calc(var(--input-gutter-start)+0.5rem)] sm:has-[[data-slot=text]:last-child]:[&_input]:pr-[var(--input-gutter-end,2.5rem)] sm:has-[[data-slot=text]:first-child]:[&_input]:pl-[var(--input-gutter-start,2.5rem)]",
        ...
        // keyboard
        "has-[[data-slot=keyboard]:last-child]:[&_input]:pr-[calc(var(--input-gutter-end)+0.5rem)] has-[[data-slot=keyboard]:first-child]:[&_input]:pl-[calc(var(--input-gutter-start)+0.5rem)] sm:has-[[data-slot=keyboard]:last-child]:[&_input]:pr-[var(--input-gutter-end,2.5rem)] sm:has-[[data-slot=keyboard]:first-child]:[&_input]:pl-[var(--input-gutter-start,2.5rem)]",
        ...
        // button
        "has-[>button:last-child]:[&_input]:pr-[var(--input-gutter-end,4rem)] has-[>button:first-child]:[&_input]:pl-[var(--input-gutter-start,4rem)] sm:has-[>button:last-child]:[&_input]:pr-[var(--input-gutter-end,3.5rem)] sm:has-[>button:first-child]:[&_input]:pl-[var(--input-gutter-start,3.5rem)]",

...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "Order_userId_status_createdAt_idx" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "Deposit_toAddress_status_idx" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "MarketActivity_userId_eventId_idx" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "SupportTicket_status_priority_createdAt_idx" 
